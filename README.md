...
- **`papertime`** — a skill that turns any body of material into a dated reading note (answer first, provenance, claims marked established, inferred, recalled or speculation, a 2,000-word ceiling, a closing section on what remains and what needs the operator's decision), with a checker and a page builder.
