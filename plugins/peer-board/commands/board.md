...
Operate the peer board for this repo. Full protocol: the **peer-board** skill (`peer-board:peer-board`).
...
where (PR, file, line), and what you think follows. State the ask.
