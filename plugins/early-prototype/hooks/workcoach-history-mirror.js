#!/usr/bin/env node
/**
 * Workcoach History Mirror - PostToolUse hook (matcher "*").
 *
 ...
 *
 *   <cwd>/.claude/workcoach-history.jsonl
 *
 ...
 * the coach's job (see skills/workcoachtime/SKILL.md). Capture is deterministic, so
...
const HISTORY_FILENAME = 'workcoach-history.jsonl';
const TAG = '[Workcoach-History-Mirror]';
